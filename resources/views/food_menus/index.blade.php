    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Food Munes</h1>
            <a href="{{route('food_menus.create') }}" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
                  @forelse ($food_menus as $food_menu)
                  <tr>
                      <td>
                          #
                      </td>
                      <td>
                          ...
                          <br/>
                          <small>
                              {{$food_menu->created_at->diffForHumans()}}
                          </small>
                      </td>
                      <td>
                      ...
                      <td class="project-actions text-right">
                          ...
                          <form method="POST" action="{{route('food_menus.destroy',$food_menu) }}">
                            <a class="btn btn-info btn-sm" href="{{route('food_menus.edit',$food_menu) }}">
