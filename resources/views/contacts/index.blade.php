      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="{{route('contacts.search') }}">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        {{Str::limit($contact->message,19)}}
                      </td>
                      <td class="project-actions text-right">
                          
                          <form method="POST" action="{{route('contacts.destroy',$contact) }}">
                            <a class="btn btn-info btn-sm" href="{{route('contacts.show',$contact) }}">
