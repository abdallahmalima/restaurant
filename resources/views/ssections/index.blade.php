      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <a href="{{route('ssections.create') }}" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="{{route('ssections.search') }}">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <br/>
                          <small>
                              {{$ssection->created_at->diffForHumans()}}
                          </small>
                      </td>
                      <td>
                        {{Str::limit($ssection->description,19)}}
                      </td>
                      <td class="project-actions text-right">
                          
                          <form method="POST" action="{{route('ssections.destroy',$ssection) }}">
                            <a class="btn btn-info btn-sm" href="{{route('ssections.edit',$ssection) }}">
