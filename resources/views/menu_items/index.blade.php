    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Menu Items</h1>
            <a href="{{route('menu_items.create') }}" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="{{route('menu_items.search') }}">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <br/>
                          <small>
                              {{$menu_item->created_at->diffForHumans()}}
                          </small>
                      </td>
                      <td>
                        {{$menu_item->price}}
                      ...
                      <td class="project-actions text-right">
                          ...
                          <form method="POST" action="{{route('menu_items.destroy',$menu_item) }}">
                            <a class="btn btn-info btn-sm" href="{{route('menu_items.edit',$menu_item) }}">
