        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('footer_links.index') }}">Home</a></li>
      ...
      <div class="row justify-content-center">
        <div class="col-md-9">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form method="POST" action="{{route('footer_links.store') }}">
                @csrf
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" name="url" value="{{old('url')  }}"" class="form-control @error('url') form-control is-invalid @enderror">
                    @error('url')
                    <small class="text-danger">*{{ $message }}*</small> 
                    @enderror
