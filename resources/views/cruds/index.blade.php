    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Cruds</h1>
            <a href="{{route('cruds.create') }}" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="{{route('cruds.search') }}">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        {{Str::limit($data->description,19)}}
                      </td>
                      <td class="project-actions text-right">
                          
                          <form method="POST" action="{{route('cruds.destroy',$data) }}">
                            <a class="btn btn-info btn-sm" href="{{route('cruds.edit',$data) }}">
