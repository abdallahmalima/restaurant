    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Testimonies</h1>
            <a href="{{route('testimonies.create') }}" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="{{route('testimonies.search') }}">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        {{Str::limit($testimony->description,19)}}
                      </td>
                      <td class="project-actions text-right">
                          
                          <form method="POST" action="{{route('testimonies.destroy',$testimony) }}">
                            <a class="btn btn-info btn-sm" href="{{route('testimonies.edit',$testimony) }}">
