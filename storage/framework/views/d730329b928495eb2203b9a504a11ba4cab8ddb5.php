    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Galleries</h1>
            <a href="<?php echo e(route('galleries.create')); ?>" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="<?php echo e(route('galleries.search')); ?>">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          ...
                          <form method="POST" action="<?php echo e(route('galleries.destroy',$gallery)); ?>">
                            <a class="btn btn-info btn-sm" href="<?php echo e(route('galleries.edit',$gallery)); ?>">
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\web\laravel\progress\my_web1\resources\views/galleries/index.blade.php ENDPATH**/ ?>