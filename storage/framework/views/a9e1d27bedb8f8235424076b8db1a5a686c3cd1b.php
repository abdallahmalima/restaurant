    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Teams</h1>
            <a href="<?php echo e(route('teams.create')); ?>" class="btn btn-tool bg-info float-sm-right">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form class="form-inline ml-3" method="GET" action="<?php echo e(route('teams.search')); ?>">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <br/>
                          <small>
                              <?php echo e($team->created_at->diffForHumans()); ?>

                          </small>
                      </td>
                      <td>
                        <?php echo e($team->occupation); ?>

                      </td>
                      <td class="project-actions text-right">
                          
                          <form method="POST" action="<?php echo e(route('teams.destroy',$team)); ?>">
                            <a class="btn btn-info btn-sm" href="<?php echo e(route('teams.edit',$team)); ?>">
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\web\laravel\progress\my_web1\resources\views/teams/index.blade.php ENDPATH**/ ?>