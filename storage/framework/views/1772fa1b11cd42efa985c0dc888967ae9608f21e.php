        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo e(route('testimonies.index')); ?>">Home</a></li>
      ...
      <div class="row justify-content-md-center">
        <div class="col-md-9">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form method="POST" action="<?php echo e(route('testimonies.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                  <label for="inputName">Testimony Person Name</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="inputName">Testimony  Title</label>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                    <label for="inputDescription">Testimony  Description</label>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\web\laravel\my_web1\resources\views/testimonies/create.blade.php ENDPATH**/ ?>