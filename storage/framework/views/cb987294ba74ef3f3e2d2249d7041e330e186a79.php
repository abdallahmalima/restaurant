    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Categories</h1>
            <a href="<?php echo e(route('categories.create')); ?>" class="btn btn-tool bg-info float-sm-right">
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\web\laravel\my_web1\resources\views/categories/index.blade.php ENDPATH**/ ?>