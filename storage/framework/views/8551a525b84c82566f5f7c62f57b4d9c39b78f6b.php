...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="inputDescription"  name="body" class="form-control <?php $__errorArgs = ['body'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="4"><?php echo e(old('body')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group text-center">
                <input type="submit" value="Send New Message" class="btn btn-success ">
               </div>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\web\laravel\progress\my_web1\resources\views/messages/create.blade.php ENDPATH**/ ?>